// Generated from the country-state-city package (same data source the web app
// (cinema-hall-users) uses for its "Select Your City" picker) — India states/UTs
// with their full list of cities/districts, so the mobile picker matches the
// web app's coverage without a runtime API dependency.
...
export const INDIA_LOCATIONS: StateLocations[] = [
  {
